...
def ejecutar(extraer_numero, fmt_sap, procesar_fecha_pesada):
    ...
    with st.container(border=True):
        ...
        # 🌟 BOTÓN VOLVER ARRIBA NATIVO (SIN IFRAMES): Ejecuta JS directamente en el DOM de Streamlit sin recargar la memoria
        st.markdown("""
            <a href="#" onclick="
                event.preventDefault();
                var main = document.querySelector('section.main') || document.querySelector('.stApp');
            ...
            " style="
                ...
                box-shadow: 0px 4px 6px rgba(0,0,0,0.3); margin-bottom: 20px; font-size: 16px; cursor: pointer;
            ">
