...
def ejecutar():
    ...
    st.write("Analiza el rendimiento de una misma finca operando desde dos bases distintas. Descubre qué pista ofrece el mejor Costo por Orden de Servicio y el mejor Rendimiento en Tiempo de Vuelo.")
    ...
    with col_filt3:
        # 💥 ESCUDO TÁCTICO: Selector de rango de fechas exacto 💥
    ...
    def calcular_metricas(df_pista):
        ...
        return total_ha, total_inversion, costo_promedio_ha, total_vuelos, costo_promedio_os, tiempo_promedio_os

    ha_A, inv_A, costo_ha_A, vuelos_A, costo_os_A, tiempo_os_A = calcular_metricas(df_A)
    ha_B, inv_B, costo_ha_B, vuelos_B, costo_os_B, tiempo_os_B = calcular_metricas(df_B)

    # Lógica de Victoria (El Costo Promedio por Hectárea más barato gana)
    ...
    with col_A:
        ...
        # 💥 REVERTIDO A COSTO POR HECTÁREA COMO LA CAJA MAYOR 💥
        ...
        # 💥 RENDIMIENTO EN HORAS DE VUELO PROMEDIO 💥
    ...
    st.caption("Comparación visual de los costos y la eficiencia de tiempo de vuelo según la pista.")
