...
# =================================================================
# 🚁 RADAR DE HECTÁREAS - OMEGA V12 (CONECTADO A SUPABASE)
# =================================================================
def ejecutar(supabase_client, descargar_matriz_rapida=None, extraer_numero_ext=None, procesar_fecha_pesada_ext=None, HAS_MATPLOTLIB=True):
    ...
    try:
        with st.spinner("🛰️ Extrayendo hectáreas desde la Bóveda Cloud..."):
        ...
        if df_rep.empty:
            st.warning("⚠️ No se encontraron registros con Fechas y Hectáreas válidas para generar el reporte.")
            return
        ...
        if df_filt.empty:
            st.warning("⚠️ No hay datos en este rango de fechas.")
            return
