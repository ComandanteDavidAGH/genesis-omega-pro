...
def ejecutar(descargar_matriz_rapida, procesar_fecha_pesada, extraer_numero):
    ...
    st.info("🤖 **MOTOR IA BI:** Extracción pura sin filtros destructivos. Ejecutando...")
    ...
    try:
        ...
        # =========================================================
        # 🎯 LÓGICA PURA Y EXACTA (Cero multiplicadores)
        # =========================================================
        ...
        # 2. PROMEDIO SIMPLE DE LA COLUMNA W
